...
var require_tslib = __commonJS({
  "node_modules/cheerio/node_modules/tslib/tslib.js"(exports, module2) {
    var __extends;
    var __assign;
    var __rest;
    var __decorate;
...
var import_cheerio = __toESM(require_lib13());
...
function PartyMember(id, watchers, listeners, templateFile, debug) {
  ...
  function loadTemplate(file) {
    const contents = import_fs.default.readFileSync(file, { encoding: "utf8", flag: "r" });
    if (!contents) {
      console.error(`Couldn't read file ${file}`);
      return void 0;
    }
    return import_cheerio.default.load(contents, null, false);
  }
}
PartyMember.prototype.clone = function() {
  const clonedWatchers = (0, import_clone_deep.default)(this.watchers);
  return new PartyMember(this.id, clonedWatchers, this.listeners, this.template, this.debug);
};
var party_member_default = PartyMember;

// app/app.component.js
var AppComponent = new party_member_default("app-component", {}, {}, "app/app.component.html");

// app/date/date.component.js
var DateComponent = new party_member_default("date-component", { date: "2021-02-01" }, {}, "app/date/date.component.html");

// app/main/main.component.js
var MainComponent = new party_member_default("main-component", {
  title: "Title",
  titleClass: "red",
  titleId: "bg-yellow",
  showTitle: true
...
// app/select/select.component.js
var SelectComponent = new party_member_default("select-component", {
  text: ["Zero", "One", "Two"]
}, {
...
var callbacks = {
  ...
  listenToNode: function(_, observable, observedProperty, node, eventName) {
    node.addEventListener(eventName, (event) => {
      if (observable.listeners[observedProperty] === void 0) {
...
function connectWatchers(obj, prefix) {
  ...
  for (const key in obj) {
    if (obj.hasOwnProperty(key)) {
      let val = obj[key];
      const keyPrefix = prefix === void 0 ? key : `${prefix}.${key}`;
      if (val instanceof Object && prefix === void 0) {
        connectWatchers.call(self2, val, keyPrefix);
        continue;
      }
...
function parseDOM(parentEl, data) {
  for (const propName in customProps) {
    ...
    const childObj = childName !== void 0 ? data[childName] : data;
